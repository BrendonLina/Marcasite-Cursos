...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/cadastrar-curso', [DashboardController::class, 'cadastrarCursos'])->name('cadastrar.cursos');
    Route::get('/curso{id}', [DashboardController::class, 'edit'])->name('editar.curso');
